...
// function test(){
//     VoiceRSS.speech({
//         key: '<9d815c0cbe7f4446bfb60b957fa2081e>',
//         src: 'Hello, world!',
//         hl: 'en-us',
//         v: 'Linda',
//         r: 0, 
...
// passing Joke to voiceRss API
    function tellMe(joke){
        ...
        VoiceRSS.speech({
         key:  `<85d14d8020aa4e69a5c3a3e05211a6fa>`,
         src: 'joke',
         hl: 'en-us',
         r: 0, 
         c: 'mp3',
...
async function getJokes(){
    let joke = '';
    const apiUrl = 'https://v2.jokeapi.dev/joke/Programming?blacklistFlags=nsfw,religious,political,racist,sexist,explicit&amount=1'
    try {
